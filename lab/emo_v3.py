#!/usr/bin/env python3
"""emo_v3.py - Reachy Mini Chat with Piper-TTS (Offline)

Replaces Edge-TTS with Piper-TTS for fully offline operation.

Usage:
  python lab/emo_v3.py --piper-model  models/en-us-blizzard_lessac-medium.onnx  # Run with specific Piper model
  python lab/emo_v3.py --asr                                                    # Enable ASR
  python lab/emo_v3.py --model qwen2.5:0.5b                                     # Set Ollama model
"""
...
from emo_v2 import EmotionControllerV6
...
# Edit below, then re-run `python lab/emo_v3.py --chat`. To prove it's offline,
    ...
    def __init__(self, model_path: str, config_path: str = None, speaker_id: int = 0, debug: bool = False):
        ...
        if not os.path.exists(model_path):
            ...
            if found_models:
                ...
                print(f"\nExample: python lab/emo_v3.py --piper-model {found_models[0]}")
            else:
