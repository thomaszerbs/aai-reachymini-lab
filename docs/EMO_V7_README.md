...
The v7_vad experimental variant has been archived and its implementation file removed. For VAD-based recording, consider adapting `utils/asr.py` which provides VAD-aware helpers and integrating them into `emo_v7.py`.
